      ...
      <div className="container-custom relative z-10 pt-32 pb-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <span className="bg-primary/10 border border-primary/30 text-primary px-4 py-2 rounded-full text-sm font-semibold">
          ...
          >
            <div className="relative mx-auto w-full max-w-sm">
              ...
              <motion.div
                ...
                className="absolute -left-4 top-1/4 bg-dark-light/90 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-white/10"
              >
              ...
              <motion.div
                ...
                className="absolute -right-4 top-1/2 bg-dark-light/90 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-white/10"
              >
              ...
              <motion.div
                ...
                className="absolute left-1/2 -translate-x-1/2 -bottom-4 bg-dark-light/90 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-white/10 whitespace-nowrap"
              >
